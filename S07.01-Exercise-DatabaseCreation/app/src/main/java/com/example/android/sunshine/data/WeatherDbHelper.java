...
//   (13) Create a private static final int called DATABASE_VERSION and set it to 1
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        final String SQL_CREATE_WEATHER_TABLE = "CREATE TABLE " + WeatherContract.WeatherEntry.TABLE_NAME + " (" +
                ...
                WeatherContract.WeatherEntry.COLUMN_WEATHER_ID + " INTEGER, gi" +
                ...
                WeatherContract.WeatherEntry.COLUMN_ZIP + " TEXT, "+
                WeatherContract.WeatherEntry.COLUMN_UPDATED + " TIMESTAMP DEFAULT CURRENT_TIMESTAMP); ";
